        ...
        elm.addEventListener("click", (event) => {
            ...
            switch (getPrefInfo(elm.id).prefName) {
                ...
                case "青森県":
                    ...
                    break;
                case "宮城県":
                    summary = "宮城県魅力は、その多彩な自然と歴史的な観光地が融合した風景です。磐井の大沼や蔵王の美しい山々、そして松島の幻想的な景色は訪れる人々を魅了します。また、仙台市の伝統的な街並みや歴史的建造物、牡鹿半島の自然豊かな風景など、地域ごとに異なる魅力があります。さらに、宮城県は海の幸や山の幸が豊富であり、新鮮な海産物や郷土料理も楽しむことができます。静かな里山や温かい地域の人々との触れ合いも、宮城県ならではの魅力です。"
                    break;
                case "埼玉県":
